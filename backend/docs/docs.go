...
var doc = `{
    ...
    "paths": {
        "/dispenses": {
            ...
            "post": {
                ...
                "operationId": "create-dispense",
                "parameters": [
                    {
                        "description": "Dispense entity",
                        "name": "dispense",
                        "in": "body",
                        "required": true,
                        "schema": {
    ...
    "definitions": {
        "ent.Dispense": {
            ...
            "properties": {
                "edges": {
                    ...
                    "type": "object",
                    "$ref": "#/definitions/ent.DispenseEdges"
                },
                "id": {
        ...
        "ent.DrugEdges": {
            ...
            "properties": {
                "dispenses": {
                    "description": "Dispenses holds the value of the dispenses edge.",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/ent.Dispense"
                    }
        ...
        "ent.Patient": {
            ...
            "properties": {
                ...
                "brithday": {
                    "description": "Brithday holds the value of the \"brithday\" field.",
                    "type": "string"
                },
                "cardid": {
