...
func (e UserEdges) DispensesOrErr() ([]*Dispense, error) {
	if e.loadedTypes[0] {
...
// QueryDispenses queries the dispenses edge of the User.
func (u *User) QueryDispenses() *DispenseQuery {
	return (&UserClient{config: u.config}).QueryDispenses(u)
}
