...
func (uc *UserCreate) AddDispenseIDs(ids ...int) *UserCreate {
	uc.mutation.AddDispenseIDs(ids...)
	return uc
}

// AddDispenses adds the dispenses edges to Dispense.
func (uc *UserCreate) AddDispenses(d ...*Dispense) *UserCreate {
	ids := make([]int, len(d))
	for i := range d {
		ids[i] = d[i].ID
	}
	return uc.AddDispenseIDs(ids...)
}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := uc.mutation.DispensesIDs(); len(nodes) > 0 {
